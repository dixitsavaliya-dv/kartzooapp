...
import { productListRequest } from '../../../modelController/productModel';
...
class ListProduct extends React.Component<{ history: any }> {
    ...
    async componentDidMount() {
        document.title = constant.listProduct + utils.getAppName();
    ...
    async getApplicationPageData() {
        ...
        // var getUserDataPagination : productListRequest = [];
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="action">
                                                        <span className="padding">
                                                            <i className="fa fa-eye" onClick={this.viewProduct}></i>
                                                            <i className="fas fa-edit" onClick={this.editProduct}></i>
                                                            <i className="far fa-trash-alt" onClick={this.deleteProduct}></i>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
