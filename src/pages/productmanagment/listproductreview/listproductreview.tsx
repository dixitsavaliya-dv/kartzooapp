...
class ListProductReview extends React.Component<{ history: any }> {
    ...
    constructor(props: any) {
        ...
        this.viewProductReview = this.viewProductReview.bind(this);
    }

    async componentDidMount() {
        document.title = constant.listMerchantReview + utils.getAppName();
    ...
    editProductImage() {
        this.props.history.push('/edit-product-image');
    }

    viewProductReview() {
        this.props.history.push('/view-product-review');
    }

    deleteProductImage() {
        Swal.fire({
            title: 'Are you sure?',
            text: 'You should be remove image!',
            icon: 'warning',
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="action">
                                                        <span className="padding">
                                                            <i className="fa fa-eye" style={{textAlign:'center'}} onClick={this.viewProductReview}></i>
                                                            {/* <i className="fas fa-edit" onClick={this.editProductImage}></i>
                                                            <i className="far fa-trash-alt" onClick={this.deleteProductImage}></i> */}
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
