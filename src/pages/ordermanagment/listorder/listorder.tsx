...
class ListOrderManagement extends React.Component<{ history: any }> {
    ...
    async componentDidMount() {
        document.title = constant.listOrderManagement + utils.getAppName();
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="action">
                                                        <span className="padding">
                                                            <i className="fa fa-eye" onClick={this.viewOrderDetails}></i>
...
export default ListOrderManagement;
