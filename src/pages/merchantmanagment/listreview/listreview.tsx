...
import { reviewListRequest } from '../../../modelController/merchantReviewModel';
...
class ListMerchantReview extends React.Component<{ history: any }> {
    ...
    viewMerchantReview() {
        this.props.history.push('/view-merchant-review');
    }
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="action">
                                                        <span className="padding">
                                                            <i className="fa fa-eye" onClick={this.viewMerchantReview}></i>
